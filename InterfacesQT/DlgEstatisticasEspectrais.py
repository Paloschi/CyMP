...
class Ui_DlgEstatisticasEspectrais(QtGui.QDialog):
    def setupUi(self, DlgEstatisticasEspectrais):
        ...
        self.leImgRefer = QtGui.QLineEdit(self.tab_3)
        self.leImgRefer.setObjectName(_fromUtf8("leImgRefer"))
        self.gridLayout.addWidget(self.leImgRefer, 1, 1, 1, 1)
        self.label_3 = QtGui.QLabel(self.tab_3)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout.addWidget(self.label_3, 1, 0, 1, 1)
        self.toolbFindImgRefer = QtGui.QToolButton(self.tab_3)
        self.toolbFindImgRefer.setObjectName(_fromUtf8("toolbFindImgRefer"))
        self.gridLayout.addWidget(self.toolbFindImgRefer, 1, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.toolButton_3, 0, 2, 1, 1)
        ...
        self.cvCV = QtGui.QCheckBox(self.tab)
        self.cvCV.setObjectName(_fromUtf8("cvCV"))
        self.gridLayout_2.addWidget(self.cvCV, 2, 0, 1, 1)
    ...
    def retranslateUi(self, DlgEstatisticasEspectrais):
        ...
        self.label_3.setText(_translate("DlgEstatisticasEspectrais", "Imagem de referencia", None))
        self.toolbFindImgRefer.setText(_translate("DlgEstatisticasEspectrais", "...", None))
        ...
        self.toolButton_3.setText(_translate("DlgEstatisticasEspectrais", "...", None))
        ...
        self.cvCV.setText(_translate("DlgEstatisticasEspectrais", "Coeficiente de variação", None))
