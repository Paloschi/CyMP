...
class UI_DlgInterpoladorShapeEcmwf(QtWidgets.QDialog):
    ...
    def setupUi(self, Form):
        ...
        self.btnFindShp = QtWidgets.QPushButton(Form)
        self.btnFindShp.setGeometry(QtCore.QRect(330, 40, 75, 23))
        self.btnFindShp.setObjectName(_fromUtf8("btnFindShp"))
        self.bbOkCancela = QtWidgets.QDialogButtonBox(Form)
        self.bbOkCancela.setGeometry(QtCore.QRect(190, 330, 156, 23))
        self.bbOkCancela.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
