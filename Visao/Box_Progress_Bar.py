...
class Ui_DlgProgressBar(QDialog):
    ...
    def confirmar_cancelamento(self):
        ...
        reply = QtWidgets.QMessageBox.question(self, 'Cancelamento',
    ...
    def setupUi(self, DlgProgressBar):
        ...
        self.console = QtWidgets.QPlainTextEdit(DlgProgressBar)
        ...
        self.btnCancelar = QtWidgets.QPushButton(DlgProgressBar)
        self.btnCancelar.setObjectName(_fromUtf8("btnCancelar"))
        self.verticalLayout.addWidget(self.btnCancelar)
        
        self.btnOk = QtWidgets.QPushButton(DlgProgressBar)
