...
class Ui_Decendial2Diario(QtGui.QDialog):
    def setupUi(self, Dialog):
        ...
        self.chDecendiais = QtGui.QCheckBox(Dialog)
        self.chDecendiais.setText(_fromUtf8(""))
        self.chDecendiais.setCheckable(False)
        self.chDecendiais.setObjectName(_fromUtf8("chDecendiais"))
        self.chDecendiais.setEnabled(False)
        self.gridLayout.addWidget(self.chDecendiais, 1, 2, 1, 1)
